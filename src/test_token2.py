...
X_train = np.load("C:\\Users\\AIA\\Desktop\\ai\\AI_mini_project\\resource\\X_train.npy")
X_test = np.load("C:\\Users\\AIA\\Desktop\\ai\\AI_mini_project\\resource\\X_test.npy")
y_train = np.load("C:\\Users\\AIA\\Desktop\\ai\\AI_mini_project\\resource\\y_train.npy")
y_test = np.load("C:\\Users\\AIA\\Desktop\\ai\\AI_mini_project\\resource\\y_test.npy")
...
model1 = create_model()
model1.fit(X11, y11, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
K.clear_session()
model2 = create_model()
model2.fit(X12, y12, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
K.clear_session()
model3 = create_model()
model3.fit(X13, y13, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
K.clear_session()
model4 = create_model()
model4.fit(X14, y14, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
K.clear_session()
# model5 = create_model()
# model5.fit(X5, y5, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
# K.clear_session()
# model6 = create_model()
# model6.fit(X6, y6, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
# K.clear_session()
# model7 = create_model()
# model7.fit(X7, y7, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
# K.clear_session()
# model8 = create_model()
# model8.fit(X8, y8, epochs=25, batch_size=5, shuffle=True, callbacks=[es], validation_split=0.2)
# K.clear_session()
...
y_pred = ensemble([model1, model2, model3, model4], X_test)#, model5, model6, model7, model8], X_test)
